...
This file adds Atomovvy repository-write coordination to this fork. It does not replace the repository's existing `AGENTS.md`, contribution rules, skill architecture, flavor rules, hook-twin requirements, test framework, packaging semantics, publishing rules, or upstream project governance.
